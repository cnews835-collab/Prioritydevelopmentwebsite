    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-white/80">Premium Commission Agency</span>
        </motion.div>
        ...
        >
          ...
          Into <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-400 text-glow">Masterpieces</span>
        </motion.h1>
        ...
        >
          We are a collective of elite digital artists and designers dedicated to bringing your unique vision to life with uncompromising quality.
        </motion.p>
